...
//Made some slight changes to accommodate for
// the multiple data requests.
...
//        table = "AAPL";
    ...
    // what it actually is
    public Stock getAPPL(String table){
        try{
            openConnection();

            // this should probably be made a class level variable at some point
            DateFormat sdf = new SimpleDateFormat("dd-MMM-yy"); //yyyy-MM-dd
